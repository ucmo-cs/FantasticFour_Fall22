                    ...
                    <div className="container">
                        <ul className="progress-bar">
                            ...
                            <li>
                                ...
                                {vcurrent === 0 &&
                                    <div onClick={(e) => {
                                        props.updateState(e, 0);
                                        setmenu(0)
                                    }} className="current"><b>1</b></div>
                                }
                                {vcurrent !== 0 &&
                                    <div onClick={(e) => {
                                        props.updateState(e, 0);
                            ...
                            <li>
                                ...
                                {vcurrent === 1 &&
                                    <div onClick={(e) => {
                                        props.updateState(e, 1);
                                        setmenu(1)
                                    }} className="current"><b>2</b></div>
                                }
                                {vcurrent !== 1 &&
                                    <div onClick={(e) => {
                                        props.updateState(e, 1);
                            ...
                            <li>
                                ...
                                {vcurrent === 2 &&
                                    <div onClick={(e) => {
                                        props.updateState(e, 2);
                                        setmenu(2)
                                    }} className="current"><b>3</b></div>
                                }
                                {vcurrent !== 2 &&
                                    <div onClick={(e) => {
                                        props.updateState(e, 2);
                            ...
                            <li>
                                ...
                                {vcurrent === 3 &&
                                    <div onClick={(e) => {
                                        props.updateState(e, 3);
                                        setmenu(3)
                                    }} className="current"><b>4</b></div>
                                }
                                {vcurrent !== 3 &&
                                    <div onClick={(e) => {
                                        props.updateState(e, 3);
                            ...
                            <li>
                                ...
                                {vcurrent === 4 &&
                                    <div onClick={(e) => {
                                        props.updateState(e, 4);
                                        setmenu(4)
                                    }} className="current"><b>5</b></div>
                                }
                                {vcurrent !== 4 &&
                                    <div onClick={(e) => {
                                        props.updateState(e, 4);
