        ...
        <>
            ...
            <form action={"./Review"}>
                <div className={"grid"}>
                    ...
                    <input onChange={changeValue} name="fname" value={user.fname} type={"text"} className={"grid-item"}
                           required/>
                    <input onChange={changeValue} name="email" value={user.email} type={"email"}
                           placeholder={"example@email.com"} className={"grid-item"} required/>
                    ...
                    <input onChange={changeValue} name="lname" type={"text"} value={user.lname} className={"grid-item2"}
                           required/>
                    <input onChange={changeValue} name="phone" type={"tel"} value={user.phone}
                           placeholder={"(888)-555-3333"} pattern={"[0-9]{3}-[0-9]{3}-[0-9]{4}"}
                           className={"grid-item2"} required/>
                ...
                <continue>
                    <button onClick={(e) => {
                        updateDetails(e, user)
                    }} className={"buttonD"}>Continue
                    </button>
                </continue>
            </form>
        </>
