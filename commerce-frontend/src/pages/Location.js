...
var locations = [
    {
        name: "Downtown Kansas City Location",
        location: {lat: 39.066567743643226, lng: -94.5886265711066},
        services: "Savings, Checking, Other"
    },
    {
        name: "Warrensburg Location", location: {lat: 38.7628, lng: -93.7360}, services: "Checking, Other"
    },
    {
        name: "Overland Park Location",
        location: {lat: 38.9822, lng: -94.6708},
        services: "Auto Loans, Credit Card, Other"
    },
    {
        name: "Topeka Location",
        location: {lat: 39.0473, lng: -95.6752},
        services: "Student Banking, CD/MM Accounts, Other"
    },
    {
        name: "Harrsionville Location",
        location: {lat: 38.6533, lng: -94.3488},
        services: "Student Loans, Savings For Retirement, Other"
    },
    {
...
export default function Location({updateLocation}) {
    ...
    return (
        <>
            ...
            <p className={"subheading"}>To select a location, select one of the options on the map below, and click
                continue</p>
            ...
            <continue>
                <button onClick={(e) => {
                    updateLocation(e, document.getElementById("loc").value)
                }} className={"buttonL"} id={"contButton"}>Continue
                </button>
            </continue>
