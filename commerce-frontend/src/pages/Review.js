...
export default function Review(props) {
    ...
    return (
        ...
        <>
            ...
            <p className={"subHeading1"}>Please ensure that all details are correct, if not, you can go back and change
                them.</p>
            ...
            <div className={"gridR"}>
                ...
                <div className={"reviewBox"}>
                    ...
                    <p className={"reviewPara"}>{props.appointment.time.getUTCMonth() + 1}/{props.appointment.time.getDate()}/{props.appointment.time.getUTCFullYear()}<br/>at <br/>11:05am
                    </p>
